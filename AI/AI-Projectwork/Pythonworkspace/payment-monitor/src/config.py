...
DEFAULT_FROM = os.getenv("SMTP_USER", "ramkotni@gmail.com")
...
EMAIL_CONFIG = {
    ...
    "smtp_password": os.getenv("SMTP_PASSWORD", "edaobpgqkjjdhovd"),
    "use_tls":       os.getenv("SMTP_USE_TLS", "true").lower() == "true",

    # Sender / Recipients
    "from_address":  os.getenv("FROM_ADDRESS", DEFAULT_FROM),
    "manager_email": os.getenv("MANAGER_EMAIL", "ramkotni@gmail.com"),
    "cc_emails":     os.getenv("CC_EMAILS", "ramkotni@gmail.com,ramkotni@gmail.com").split(","),
